...
LOCATION = "asia-east1"
FUNCTION_URL = f"https://trigger-run-job-312742415715.asia-east1.run.app"  # Cloud Function B 的 URL
...
def create_task(symbols: list, dt: str):
    ...
    SERVICE_ACCOUNT = "cloud-run@bionic-region-455813-b0.iam.gserviceaccount.com"
