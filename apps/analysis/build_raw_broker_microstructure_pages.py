...
STRATEGIES: dict[str, dict[str, Any]] = {
    "diffuse_buyer_accumulation": {
        ...
        "theme": "#0b6b57",
        "entry": "訊號隔日開盤進場；只在買方廣度與買賣平衡同時過門檻時進場。",
        "exit": "目前展示版以固定持有 60 個交易日出場，並搭配 20 日 cooldown。",
    ...
    "role_reversal": {
        ...
        "theme": "#315f8c",
        "entry": "訊號隔日開盤進場；先確認分點角色反轉分數與價格轉強同步成立。",
        "exit": "目前展示版以固定持有 60 個交易日出場，並搭配 10 日 cooldown。",
    ...
    "sell_pressure_absorption": {
        ...
        "theme": "#b7791f",
        "entry": "訊號隔日開盤進場；先確認賣壓高分位但價格不弱、且有足夠買方承接。",
        "exit": "目前展示版以固定持有 60 個交易日出場，並搭配 10 日 cooldown。",
...
EXTRA_STRATEGIES: dict[str, dict[str, Any]] = {
    "key_broker_branch_hybrid": {
        ...
        "html": "",
        "theme": "#874f24",
        "entry": "訊號隔日開盤進場；先通過關鍵分點異常買超與突破條件。",
        "exit": "目前展示版以固定持有 30 個交易日出場，未加 stop loss。",
    ...
    "warrant_leads_stock": {
        ...
        "theme": "#0f6f8f",
        "entry": "訊號隔日開盤進場；只有權證端夠強、現股尚未完全反映時才進場。",
        "exit": "目前展示版以固定持有 40 個交易日出場，並加上 20 日 cooldown 與 -10% stop loss。",
    ...
    "direction3_breakout": {
        ...
        "theme": "#2f6f45",
        "entry": "模型分數與 day-buy20 gate 都過關後，下一個交易日開盤進場；若 next-open gap 過大則排除。",
        "exit": "目前展示版以固定持有 16 個交易日出場，並限制 max_positions = 6。",
